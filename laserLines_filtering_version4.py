...
params = {
    ...
    'file_name': '/home/nehla/laser_code/fc2_save_2018-07-09-234632-0001.avi',
    # 'file_name': '/home/nehla/laser_code//home/nehla/laser_code/fc2_save_2018-07-09-234632-0001.avi',
    
    'save_file_name': '/home/nehla/laser_code/save-FenceMask.avi',
...
while(cap.isOpened()):
    ...
    if buffer_binaries_size < int(width/10) :
